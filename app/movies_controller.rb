...
def can_be_found_updated_and_saved
  ...
  mov_to_upt = Movie.find_by(title: "Awesome Flick")
  mov_to_upt.update(title: "Even Awesomer Flick")
  mov_to_upt.save
end
...
def can_update_using_update_method
  ...
  mov_to_upt = Movie.find_by(title: "Wat?")
  mov_to_upt.update(title: "Wat, huh?")
end
